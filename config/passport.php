...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | Define password grant
    |
    | We use this ID and SECRET to be sure we only revoke old tokens that are
    | our first party apps, as we enforce one active auth token at a time
    |
    */
